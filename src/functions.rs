...
pub fn world_gen(WorldSizeVar:usize, random_chance:i32) -> Grid<u8>{
    let mut world: Grid<u8> = Grid::new(WorldSize, WorldSize);
...
pub fn neighborhood(world:&Grid<u8>,X_Cell:usize, Y_Cell:usize) -> i32{
    let mut neighbors = 0;
...
pub fn printScreen(world:Grid<u8>) -> Grid<u8>{
